    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holder', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.alumnus')),
            ],
        ),
        migrations.AddField(
            model_name='alumnus',
            name='created_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='created_by', to='core.user'),
        ),
        migrations.AddField(
            model_name='alumnus',
            name='user',
