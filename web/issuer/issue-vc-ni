...
# Sole purpose of this script is to run `issue-credential` in a non-interactive
...
printf $args | issue-credential \
    ...
    --export ${OUTFILE}
# TODO: Check here output of the above command and exit with appopriate status
# code
exit 0
